...
CaDyn = initializeCalciumDynamics("CaT", -0.94, 0.05, 20)

# Building a more complex model with calcium
ionCurrents = [NaCurrent, CaTCurrent, KCaCurrent, KdCurrent]
bigModel = initializeNeuronModel(ionCurrents, C=0.1, calciumDynamics=CaDyn, maximumConductances=[200, 50, 2, 40])
